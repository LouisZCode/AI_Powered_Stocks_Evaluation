...
all_routes = [financial_ingestion_router, financial_analisys_router, financial_harmonization_router, financial_debate_router, financial_report_router, auth_router, watchlist_router, payments_router]
