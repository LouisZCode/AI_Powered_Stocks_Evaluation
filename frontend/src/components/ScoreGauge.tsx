...
interface Props {
  ...
  size?: number;
  /** Render as empty gray gauge with no needle */
  empty?: boolean;
}

export default function ScoreGauge({ score = 0, max = 8, size = 64, empty = false }: Props) {
  ...
  return (
    <svg width={size} height={size * 0.6} viewBox="0 0 100 62" fill="none">
      ...
      <path
        ...
        stroke={empty ? "rgba(255,255,255,0.08)" : "rgba(255,255,255,0.06)"}
        strokeWidth={6}
        strokeLinecap="round"
        fill="none"
      />
