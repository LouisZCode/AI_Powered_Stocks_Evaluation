      ...
      >
        ...
        <div className="flex flex-col gap-3">
          <a
            ...
            className="flex items-center justify-center gap-3 w-full rounded-xl bg-white/[0.06] border border-white/[0.08] text-white/80 hover:bg-white/[0.10] hover:text-white transition-all duration-200"
        ...
        {/* Footer toggle */}
        <p
          className="text-center text-white/30 mt-6"
          style={{ fontSize: 12 }}
        >
          {mode === "login" ? (
            <>
